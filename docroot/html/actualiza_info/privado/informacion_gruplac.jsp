...
<form id="formularioRegistro" action="<%=actionForm%>" method="POST">
	...
	<select name="nacionalidad" id="nacionalidad"><option value="C">Colombiana</option> 
                    ...
                    <option value="E">Extranjero - otra</option></select>
                    
    
	<label for="paisNacimiento">Pa&#237;s de nacimiento</label>                
    <select name="paisNacimiento" id="paisNacimiento"><option value="COL">Colombia</option>
...
<option value="ULM">Islas ultramarinas de Estados Unidos</option>
<option value="VGB">Islas Vírgenes</option>
<option value="IVA">Islas Vírgenes de los Estados Unidos</option>
...
<option value="ZIN">Zimbabue</option></select>
